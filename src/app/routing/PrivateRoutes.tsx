...
import { DashboardDetail } from '../pages/Detail/DetailPage'
  ...
  return (
    <Suspense fallback={<FallbackView />}>
      <Switch>
        ...
        <Route path='/detail-scraping/:id' component={DashboardDetail} />
        ...
        <Redirect from='/auth' to='/scraping' />
        <Redirect exact from='/' to='/scraping' />
